...
N $6C01 Initial set-up; copies "clean" data to the "CopyOf..." store. This is then used to create a new game in #R$6C27.
  $6C01,$0B Copies #R$C11B to #R$F400 (#N$0615 bytes).
  $6C0C,$08 Copies #R$BA8A to #R$FA15 (#N$05D9 bytes).
  $6C14,$0B Copies #R$B6EB to #R$5F00 (#N($001D,$04,$04) bytes).
  $6C1F,$08 Copies #R$CA84 to #R$5F1D (#N($00BF,$04,$04) bytes).
@ $6C27 label=ReStart
...
N $6C3F Copy "clean" data to the game tables ready for a new game.
  $6C3F,$0B Copies #R$F400 to #R$C11B (#N$0615 bytes).
  $6C4A,$08 Copies #R$FA15 to #R$BA8A (#N$05D9 bytes).
  $6C52,$0B Copies #N$5F00 to #R$B6EB (#N($001D,$04,$04) bytes).
  $6C5D,$08 Copies #N$CA84 to #N$5F1D (#N($00BF,$04,$04) bytes).
  $6C65,$03 Set the border colour to #INK$00.
  $6C68,$05 #HTML(Write #COLOUR$38 to <a rel="noopener nofollow" href="https://skoolkid.github.io/rom/asm/5C48.html">BORDCR</a>.)
...
. TABLE#
  ...
  $6C7F,$06 Write #N$50E0 to #R$85B4(the percentage buffer).
  $6C85,$05 Write #N$2B to #R$85B4($85B6).
  $6C8A,$06 Write #N$5020 to #R$869C.
  $6C90,$05 Write #N$01 to #R$869E.
  $6C95,$05 Write #N$20 to #R$85B3.
  $6C9A,$05 Write #N$2A to #R$869B.
  $6C9F,$08 Write #N$00 to #N$C8 bytes, starting from #R$B738 (using #R$70E2).
  $6CA7,$05 #REGr = refresh register; i.e. write a semi-random number to #R$B70E.
  $6CAC,$10 Write #N$00 to;
.           #LIST
.           { #R$869F }
.           { #R$86A0 }
.           { #R$B71A }
...
.           { #R$B6F2 }
.           LIST#
  $6CBC,$0B Write #N$01 to;
.           #LIST
.           { #R$B702 }
.           { #R$B6FA }
.           { #R$B704 }
.           LIST#
  $6CC7,$06 Write #N($0000,$04,$04) to #R$B6F7.

c $6CCD Squiggle Line
@ $6CCD label=SquiggleLine
D $6CCD This section draws the "Squiggle" line which separates the windows.
E $6CCD Continue on to #R$6CEC.
N $6CCD #PUSHS #UDGTABLE { #SIM(start=$6CCD,stop=$6CEC) #SCR$04,$00,$12,$20,$01(squiggle) } UDGTABLE# #POPS
  $6CCD,$03 Call #R$6FD3.
  $6CD0,$03 #REGhl=#N$5140 (screen buffer position).
  $6CD3,$03 #REGde=#R$6DCC.
  $6CD6,$02 #REGc=#N$05.
@ $6CD8 label=SquiggleGFX_Outer_Loop
  $6CD8,$02 Set a counter of #N$10.
  $6CDA,$01 Stash #REGhl (the screen buffer pointer) temporarily - this is because the line is a repeated pattern.
@ $6CDB label=SquiggleGFX_Inner_Loop
...
c $6CEC
  ...
  $6D06,$0B Copies #N$6FF4 to #N$6FF9 ($05 bytes).
  $6D11,$02 Jump to #R$6D22.

  $6D13,$05 Write #N$01 to #R$B705.
  $6D18,$05 Write #N$09 to #R$B716.
  $6D1D,$03 Call #R$6DD6.

  $6D22,$08 Write #N$00 to #N$40 bytes, starting from #R$709C (using #R$70E2).
...
@ $6FD3 label=ClearScreen
  $6FD3,$03 Stash #REGhl, #REGde and #REGbc on the stack.
  $6FD6,$04 Set the border colour to #INK$07.
  $6FDA,$0D Write #N$00 to #N$1800 memory locations (clearing the screen buffer).
  $6FE7,$07 Write #COLOUR$38 to the following #N$0300 memory locations (the attribute buffer).
  $6FEE,$03 Restore #REGbc, #REGde and #REGhl from the stack.
  $6FF1,$01 Return.
...
c $70E8 Index Action
R $70E8 A The ID of the Action; #N$01-#N$3B
...
c $72CE Response: "I Cannot Do That"
@ $72CE label=Response_ICannotDoThat
...
N $72E8 Important.
  $72E8,$06 If #R$B6FA is not zero, jump to #R$72F1
  $72EE,$03 Stash #REGa at #R$B6FB.
...
N $7318 Check.
  $7318,$04 If the character is less than #N$20 jump to #R$7326.
  $731C,$05 If the character is more than #N$60 jump to #R$7493.
...
@ $7326 label=PrintMsg_PrintTable
  ...
  $732D,$02 #REGhl=(#REGde * #N$02,$02,$01,$01($))
  ...
  $7334,$04 If the character is more than #N$14,$02,$01,$01($) jump to #R$733F.
  $7338,$03 Call #R$733F.
...
@ $7493 label=GetCommonWord
  $7493,$02 Subtract #N$60 from the letter byte - anything higher than #N$60 signifies the letter is a "common word".
  ...
  $74A0,$02 Add #N$50 to #REGa and store the result in #REGd.
...
R $74C1 DE e.g. #N$56D1 token?
  ...
  $74D6,$02 Intialise #REGb to #N$00 to count the number of letters.
@ $74D8 label=PrintToken_Loop
  ...
  $74DE,$02 Add #N$60 to #REGa to convert to ASCII.
...
N $74E7 Check minimum length.
  ...
  $74E8,$04 If the number of characters is only #N$02 then jump back to #R$74D8 to continue processing.
  $74EC,$04 If it is not #N$03, then jump to #R$74F9.
...
B $757B,$0A
  ...
  $758D,$03 Call #R$785F.
  $7590,$03 Write #N$00 to #R$B706.
  $7593,$02 #REGe=$FF.
  $7595,$03 #REGa=#R$B71A.
  $7599,$02 #REGd=$A0.
  $759B,$03 If #REGa is not zero jump to #R$7614.
  $75A0,$04 Write #N$00 to #R$757A.
  $75B1,$03 Call #R$7864.
  $75B4,$08 Write #N$00 to #N$0A bytes, starting from #R$757B (using #R$70E2).
...
D $7F77 Contains #N$FF when the location has no graphics data, else the location ID.

c $7F78 Drawing Routine
@ $7F78 label=Drawing
  $7F78,$01 Store #REGaf on the stack.
  $7F79,$06 If #R$B707 is not #N$00 then jump to #R$7F86.
  $7F7F,$05 Write #N$FF to #R$7F77.
...
@ $7FBC label=DrawingLoop
  ...
  $7FC5,$04 If the graphics data value which was fetched is not #N$08 (move to X/Y) jump to #R$7FD5.
...
@ $820B label=DrawingClear
  ...
  $8217,$02 Overwrite the graphic data in the shadow #REGaf register to #N$00 (black).
  $8219,$01 Switch back to the "normal" #REGaf register simply to accommodate the jump from #R$8215.
@ $821A label=DrawingBorder
  $821A,$01 Switch to the shadow #REGaf register containing the first byte of the graphic data (or #N$00 if it's dark).
  $821B,$02 Set the border colour to the value in #REGa.
  $821D,$03 Store #REGhl, #REGde and #REGbc on the stack.
  $8220,$0D Write #N$00 to #N$4000-#N$4FFF (the screen buffer).
  ...
  $823E,$02 Overwrite the graphic data in the shadow #REGaf register to #N$00 (black).
  $8240,$01 Switch back to the "normal" #REGaf register simply to accommodate the jump from #R$823C.
@ $8241 label=DrawingPaper
  $8241,$01 Switch to the shadow #REGaf register containing the second byte of the graphic data (or #N$00 if it's dark).
...
@ $83F5 label=GameOver_Start
  ...
  $8418,$03 Call #R$858B.
  $841B,$03 #REGa=the percentage digit, plus #N$30 to convert to ASCII.
  $841E,$03 Call #R$858B.
  $8421,$04 Write #N$00 to #R$B704.
...
@ $842E label=PercentageAscii
  $842E,$02 #REGa=$2F (ASCII "0" less one, due to the following line being the loop and so, incrementing to #N$30 - which is ASCII "0").
@ $8430 label=PercentageAscii_Loop
  ...
  $8437,$02 Compare against #N$30 (ASCII "0") to set flags for the return.
  $8439,$01 Return.

N $843A I don't believe this is ever used?
  $843A,$04 Set the border to #N$04 (green).
  $843E,$03 Call #R$84B9.
...
.           Hence keep only bits 0-4 for the check.
  ...
  $844A,$04 Set the border to #N$07 (white).
...
N $847B Load "locations".
  ...
  $8482,$03 Set the block length to; #N$05D9 bytes.
  $8485,$03 Call #R$8498.
N $8488 Success!
...
@ $8498 label=LoadBlock
  $8498,$03 #HTML(Call <a rel="noopener nofollow" href="https://skoolkid.github.io/rom/asm/0556.html">LD_BYTES</a>.)
  $849B,$01 Return if the carry flag is set.
  $849C,$05 Write #N$01 to #R$B701.
...
N $84E6 Save "flags".
  ...
  $84EC,$03 Set the block length to; #N$001D bytes.
  $84EF,$03 #HTML(Call <a rel="noopener nofollow" href="https://skoolkid.github.io/rom/asm/04C2.html">SA_BYTES</a>.)
N $84F2 Save "objects".
  $84F2,$02 Set the save as a "data block".
  $84F4,$04 Set the start address to; #R$C11B.
  $84F8,$03 Set the block length to; #N$0615 bytes.
  $84FB,$03 #HTML(Call <a rel="noopener nofollow" href="https://skoolkid.github.io/rom/asm/04C2.html">SA_BYTES</a>.)
N $84FE Save ...
  $84FE,$02 Set the save as a "data block".
  $8500,$04 Set the start address to; #N$CA84.
  $8504,$03 Set the block length to; #N($00BF,$04,$04) bytes.
  $8507,$03 #HTML(Call <a rel="noopener nofollow" href="https://skoolkid.github.io/rom/asm/04C2.html">SA_BYTES</a>.)
N $850A Save "locations".
  $850A,$02 Set the save as a "data block".
  $850C,$04 Set the start address to; #R$BA8A.
  $8510,$03 Set the block length to; #N$05D9 bytes.
  $8513,$03 #HTML(Call <a rel="noopener nofollow" href="https://skoolkid.github.io/rom/asm/04C2.html">SA_BYTES</a>.)
...
N $851F Verify "flags".
  ...
  $8526,$03 Set the block length to; #N$001D bytes.
  $8529,$03 Call #R$855A.
N $852C Verify "objects".
  ...
  $8533,$03 Set the block length to; #N$0615 bytes.
  $8536,$03 Call #R$855A.
N $8539 Verify ...
  $8539,$02 Set the load as a "data block".
  $853B,$01 Reset the carry flag.
  $853C,$04 Set the start address to; #N$CA84.
  $8540,$03 Set the block length to;#N($00BF,$04,$04) bytes.
  $8543,$03 Call #R$855A.
N $8546 Verify "locations".
  ...
  $854D,$03 Set the block length to; #N$05D9 bytes.
  $8550,$03 Call #R$855A.
N $8553 Success!
...
@ $855A label=VerifyBlock
  $855A,$03 #HTML(Call <a rel="noopener nofollow" href="https://skoolkid.github.io/rom/asm/0556.html">LD_BYTES</a>.)
  $855D,$01 Return if the carry flag is set.
  $855E,$05 Write #N$01 to #R$B701.
...
N $867A #HTML(Prints using the standard ZX Spectrum <a rel="noopener nofollow" href="https://skoolkid.github.io/rom/asm/3D00.html">CHARSET</a>.)
...
. { =h Letter | =h ASCII Value | =h SUB #N($20,$02,$03,$01,$01)($) | =h * $08 | =h CHARSET + offset }
. { #LET(id=$41) #LET(result=$3D00+({id}-$20)*$08) "#CHR({id})" | #N({id},$02,$03,$01,$01)($) | #N({id}-$20,$02,$03,$01,$01)($) | #N(({id}-$20)*$08,$02,$03,$01,$01)($) | #HTML(<a rel="noopener nofollow" href="https://skoolkid.github.io/rom/asm/3D00.html##N({result},$02,$03,$01,$01)()">#N({result},$02,$03,$01,$01)($)</a>) }
. { #LET(id=$51) #LET(result=$3D00+({id}-$20)*$08) "#CHR({id})" | #N({id},$02,$03,$01,$01)($) | #N({id}-$20,$02,$03,$01,$01)($) | #N(({id}-$20)*$08,$02,$03,$01,$01)($) | #HTML(<a rel="noopener nofollow" href="https://skoolkid.github.io/rom/asm/3D00.html##N({result},$02,$03,$01,$01)()">#N({result},$02,$03,$01,$01)($)</a>) }
. { #LET(id=$61) #LET(result=$3D00+({id}-$20)*$08) "#CHR({id})" | #N({id},$02,$03,$01,$01)($) | #N({id}-$20,$02,$03,$01,$01)($) | #N(({id}-$20)*$08,$02,$03,$01,$01)($) | #HTML(<a rel="noopener nofollow" href="https://skoolkid.github.io/rom/asm/3D00.html##N({result},$02,$03,$01,$01)()">#N({result},$02,$03,$01,$01)($)</a>) }
. TABLE#
  $8686,$04 #HTML(Calculate font graphic data address using <a rel="noopener nofollow" href="https://skoolkid.github.io/rom/asm/3D00.html">CHARSET</a> + offset.)
  $868A,$03 Store the result in #REGde, restore the screen location to #REGhl.
@ $868F label=PrintChar_Loop
  $868D,$02 Set a counter for #N$08 lines.
...
@ $877D label=ScrollLine_Line
  ...
  $878E,$06 #REGde=#REGde + #N$20 and #REGhl=#REGhl + #N$20.
...
. { #LET(id=$21) "#CHR({id})" | #N({id},$02,$03,$01,$01)($) | #N(#EVAL({id}*$08),$02,$03,$01,$01)($) | (#N({id},$02,$03,$01,$01)($)*$08)+$8722 | #R(#EVAL($8722+({id}*$08))) }
. { #LET(id=$41) "#CHR({id})" | #N({id},$02,$03,$01,$01)($) | #N(#EVAL({id}*$08),$02,$03,$01,$01)($) | (#N({id},$02,$03,$01,$01)($)*$08)+$8722 | #R(#EVAL($8722+({id}*$08))) }
. { #LET(id=$61) "#CHR({id})" | #N({id},$02,$03,$01,$01)($) | #N(#EVAL({id}*$08),$02,$03,$01,$01)($) | (#N({id},$02,$03,$01,$01)($)*$08)+$8722 | #R(#EVAL($8722+({id}*$08))) }
. TABLE#
...
N $87D0 Calculate font graphic data address.
  ...
  $87DA,$02 Set a counter for #N$08 lines.
...
b $8822 Main Font
@ $8822 label=MainFont
N $8822 #LET(id=#EVAL($20+(#PC-$8822)/$08))CHARACTER: "#MAP({id})(#CHR({id}),$20:SPACE,$60:£,$7F:CLARET)".
  $8822,b,$01 #UDG(#PC)
L $8822,$08,$60
...
@ $8B93 label=GetKey
  ...
  $8B97,$03 Call #R$8B78.
  $8B9A,$04 Write #N($0000,$04,$04) to #R$8B89.
  $8B9E,$03 #REGhl=$8B8B.
  $8BA1,$04 #REGix=#R$8B81.
  $8BA5,$03 #REGbc=#N$FEFE.
...
N $8BC9 If no key match was found, end...
  $8BC9,$04 If #REGbc is #N($0000,$04,$04), jump to #R$8BF6.
  $8BCD,$02 #REGa=#N$FB.
  $8BCF,$02 #REGa+=#N$05.
...
@ $93DA label=Action_Examine
  ...
  $93E9,$05 If this value is not #N($0000,$04,$04) then jump to #R$72DD.
...
@ $959B label=CheckLit
  $959B,$07 If #R$B6FA is not #N$01 then jump to #R$95C7.
N $95A2 This check is a little unnecessary as the first thing the routine at #R$95ED does, is to check exactly this...
  $95A2,$07 If #R$B6EA is not #N$00 (i.e. "#TEXTTOKEN($C11B+$08,$01)") then skip the "is location lit" check, instead jump to #R$95AF.
...
@ $965B label=YouSeeStart
  ...
  $966E,$03 Call #R$7F78.
  $9671,$07 Test if #R$7F77 contains #N$FF, call #R$969A if it does not (i.e. wait for a keypress only if something has been drawn).
  $9678,$03 Call #R$8583.
...
@ $9689 label=YouSeeNext
  ...
  $968E,$04 #REGiy=#REGix.
  $9692,$02 #REGiy+=#N($0002,$04,$04) (from #REGde).
  $9694,$03 Call #R$9ED6.
...
R $9A85 A The index to search for
  ...
  $9A96,$01 Increase the pointer address by #N($0007,$04,$04) (using #REGde).
...
@ $9B6C label=TriggerAction
  ...
  $9B73,$05 Call #R$9B80 if #REGhl is not empty (i.e. #N($0000,$04,$04)).
...
@ $9BB1 label=LocateLocation
  $9BB1,$04 If the location ID is less than #N$50 jump to #R$9BB7 to process it.
  $9BB5,$01 Reset #REGa to #N$00.
  $9BB6,$01 Return.
...
. TABLE#
  $9BBF,$02 #REGhl=(#REGhl * #N$02)+#REGde
...
c $9C41
  ...
  $9C4E,$04 Set #REGix to #N$C060 which is 3 bytes less than the start of the #R$C063(object table) due to the following
.           line adding #N($0003,$04,$04) and moving us on to the first record.
  $9C52,$03 Call #R$9B93.
  $9C55,$02 Jump to #R$9C6D if we've reached the end of the object data.
  $9C57,$07 If the TODO is not #N$01 (TODO), then loop back round to #R$9C52 to move onto the next record.
N $9C5E Success! We've found a record which matches #N$01 (TODO).
...
@ $9CA8 label=CalcRandom
  ...
  $9CBA,$02 If the LSB has not "rolled over" to #N$00, skip updating the MSB on the following line. Jump to #R$9CB2.
...
c $9D44
  $9D44,$06 If #R$B6FA is #N$01 then return.
  ...
  $9D5E,$04 Set #REGix to #N$C060 which is 3 bytes less than the start of the #R$C063(object table) due to the following
.           line adding #N($0003,$04,$04) and moving us on to the first record.
  $9D62,$03 Call #R$9BA9.
...
@ $9D97 label=ObjectCount
  ...
  $9D9E,$04 Set #REGix to #N$C060 which is 3 bytes less than the start of the #R$C063(object table) due to the following
.           line adding #N($0003,$04,$04) and moving us on to the first record.
...
R $9E7A O:A Either #N$FF if this object is not inside a container, or the object ID of the container object
...
c $9E95
  ...
  $9E96,$03 Call #R$9D37.
  $9E99,$05 Add #N($0007,$04,$04) to the object location.
...
c $9F76
  ...
  $9F7D,$04 Write #N$00 to #R$B6FB.
  $9F81,$01 Return.

c $9F82 Get Object First Location
R $9F82 A Object ID
R $9F82 O:A Either #N$FF if the object appears once, or the location ID of the first time the object appears.
@ $9F82 label=ObjectFirstLocation
  ...
  $9F8D,$02 #REGa=#N$FF (termination character).
...
c $9F94
  ...
  $9FD5,$04 Set #REGix to #N$C060 which is 3 bytes less than the start of the #R$C063(object table) due to the following
.           line adding #N($0003,$04,$04) and moving us on to the first record.
  $9FD9,$03 Call #R$9BA9.
  $A00E,$03 Call #R$9E34.
  $A01B,$03 Call #R$9EC7.
...
c $A55F c
  ...
  $A602,$02 Is the player inside object #N$13, i.e. using the "#TEXTTOKEN($C3EE+$08,$01)"?
  ...
  $A918,$05 Set #R$B702 to #N$01 (daytime).
...
@ $BA8A label=Locations
  $BA8A,$0D 00:  : ''
N $BA97 Location #N$01 - "#TEXTTOKEN(#PC+$02,$01)"
...
N $BAA5 Location #N$04 - "#TEXTTOKEN(#PC+$02,$01)"
...
N $BABC Location #N$05 - "#TEXTTOKEN(#PC+$02,$01)"
...
N $BAD0 Location #N$06 - "#TEXTTOKEN(#PC+$02,$01)"
...
N $BAE1 Location #N$07 - "#TEXTTOKEN(#PC+$02,$01)"
...
N $BAEF Location #N$09 - "#TEXTTOKEN(#PC+$02,$01)"
...
N $BB00 Location #N$0A - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BB17 Location #N$0B - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BB2B Location #N$0C - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BB3C Location #N$0E - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BB4D Location #N$0F - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BB61 Location #N$34 - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BB75 Location #N$35 - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BB83 Location #N$36 - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BB9A Location #N$37 - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BBB1 Location #N$38 - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BBBF Location #N$39 - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BBD3 Location #N$3A - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BBEA Location #N$3B - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BBFB Location #N$3C - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BC0F Location #N$3D - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BC20 Location #N$3E - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BC2E Location #N$3F - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BC42 Location #N$40 - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BC56 Location #N$41 - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BC6A Location #N$10 - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BC7E Location #N$11 - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BC8C Location #N$12 - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BCA0 Location #N$13 - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BCC9 Location #N$14 - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BCDA Location #N$0D - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BCEB Location #N$15 - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BCFC Location #N$16 - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BD16 Location #N$18 - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BD2A Location #N$19 - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BD3E Location #N$1A - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BD55 Location #N$1B - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BD66 Location #N$1C - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BD7A Location #N$1D - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BD88 Location #N$1E - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BD9C Location #N$1F - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BDAD Location #N$20 - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BDC1 Location #N$21 - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BDD5 Location #N$22 - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BDEC Location #N$23 - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BE03 Location #N$24 - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BE14 Location #N$25 - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BE25 Location #N$26 - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BE39 Location #N$27 - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BE4D Location #N$28 - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BE61 Location #N$29 - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BE75 Location #N$2A - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BE89 Location #N$2B - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BE9A Location #N$2C - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BEB1 Location #N$2E - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BEC2 Location #N$2D - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BED3 Location #N$02 - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BEE4 Location #N$03 - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BEF5 Location #N$08 - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BF06 Location #N$17 - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BF17 Location #N$30 - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BF2B Location #N$31 - "#TEXTTOKEN(#PC + $02, $01)"
...
N $BF42 Location #N$2F - "#TEXTTOKEN(#PC + $02, $01)"
